...
RT_IN = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "A34H_UNC", u"Resistivity - Cased Hole", u"ohm.m")
parameterDict.update({'RT_IN' : Parameter(name='RT_IN',bname='rt_in',type='Variable',family='Resistivity - Cased Hole',unit='ohm.m',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.A34H_UNC',mode='In',description='Known Rt for mode 1&2',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:rm_in
...
#Format:auto
RT_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "RT_INVERT", u"Array Resistivity", u"OHMM")
RT_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'RT_INVERT' : Parameter(name='RT_INVERT',bname='rt_invert',type='Variable',family='Array Resistivity',unit='OHMM',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.RT_INVERT',mode='Out',description='inverted formation resistivity',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:dh_invert
...
#Format:float
DH_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "DH_INVERT", u"Borehole Radius", u"IN")
DH_INVERT.setStorageFormat('float')
DH_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'DH_INVERT' : Parameter(name='DH_INVERT',bname='dh_invert',type='Variable',family='Borehole Radius',unit='IN',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.DH_INVERT',mode='Out',description='inverted hole diameter',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True',fmt='float')})
#Type:Variable
#BName:rm_invert
#Family:Array Resistivity
#Unit:OHMM
...
#Format:float
RM_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "RM_INVERT", u"Array Resistivity", u"OHMM")
RM_INVERT.setStorageFormat('float')
RM_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'RM_INVERT' : Parameter(name='RM_INVERT',bname='rm_invert',type='Variable',family='Array Resistivity',unit='OHMM',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.RM_INVERT',mode='Out',description='inverted mud resistivity',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True',fmt='float')})
#Type:Variable
#BName:epsr_invert
#Family:Permittivity
#Unit:unitless
...
#Format:auto
EPSR_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "EPSR_INVERT", u"Permittivity", u"unitless")
EPSR_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'EPSR_INVERT' : Parameter(name='EPSR_INVERT',bname='epsr_invert',type='Variable',family='Permittivity',unit='unitless',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.EPSR_INVERT',mode='Out',description='inverted tool eccentricity',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:err_invert
#Family:
#Unit:%
...
#Format:auto
ERR_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "ERR_INVERT", u"", u"%")
ERR_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'ERR_INVERT' : Parameter(name='ERR_INVERT',bname='err_invert',type='Variable',family='',unit='%',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.ERR_INVERT',mode='Out',description='inverted error in %',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:qc_invert
#Family:
#Unit:
...
#Format:auto
QC_INVERT = Variable("Zabazaba - 1X", "ARC5_MWD_010PDP_60B", "QC_INVERT", u"", u"")
QC_INVERT.setGroupName("ARCeCaliper")
parameterDict.update({'QC_INVERT' : Parameter(name='QC_INVERT',bname='qc_invert',type='Variable',family='',unit='',value='Zabazaba - 1X.ARC5_MWD_010PDP_60B.QC_INVERT',mode='Out',description='inversion QC',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#DeclarationsEnd
import sys
import os
import ctypes
